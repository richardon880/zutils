...
def drop_invalid(df):
    ...
    feature_data = df[['gPSFMag', 'gApMag', 'gKronMag', 'gpsfChiSq', 'gKronRad', 'rPSFMag',
       'rApMag', 'rKronMag', 'rpsfChiSq', 'rKronRad', 'iPSFMag', 'iApMag',
       'iKronMag', 'ipsfChiSq', 'iKronRad', 'zPSFMag', 'zApMag', 'zKronMag',
       'zpsfChiSq', 'zKronRad', 'yPSFMag', 'yApMag', 'yKronMag', 'ypsfChiSq',
       'yKronRad']]
...
def get_in_range_magnitudes(df):
    ...
    lwr_mag_lim = 0 #17
    upper_mag_lim = 19.72
    to_flag = df.query("rKronMag < @lwr_mag_lim or\
                   rKronMag > @upper_mag_lim").index.values
    to_flag_mask = np.isin(df.index, to_flag)
